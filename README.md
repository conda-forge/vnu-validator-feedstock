...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/vnu-validator-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/vnu-validator-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add vnu-validator
# for installing globally
pixi global install vnu-validator
```
...
It is possible to list all of the versions of `vnu-validator` available on your platform:
...
```
pixi search vnu-validator --channel conda-forge
```
